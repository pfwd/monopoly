...
//    
//    game.excuteTurn(player);
//}
//
//var playerRanking = [];
//for(var i = 0; i < game.players.length; i++){
//    // Calculate the remaining funs
//    var finalFunds = game.players[i].funds;
//    // Calculate property value
//    var propertyValue = game.players[i].sumBoughtItems();
//    var playerScore ={
//        name: game.players[i].name,
//        finalFunds: finalFunds,
//        propertyValue: propertyValue,
//        totalValue: finalFunds + propertyValue
//    };
//    
//    playerRanking.push(playerScore);
//}
//console.log(playerRanking);
////var maxX = Math.max.apply( Math, playerRanking );
////var index = playerRanking.indexOf(maxX);
////
////alert(game.players[index].name +  ' has won');